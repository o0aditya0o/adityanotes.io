export default function BorrowedGlasses() {
    return (
        <>
            ...
            <h3>A concrete example: joining “that” team</h3>
            <p>
                Imagine joining a new team and, before you’ve written a single line of code, you hear the whispers:
            </p>
            <ul>
                <li>“Not a high-impact team.”</li>
                <li>“Career dead end.”</li>
                <li>“No serious engineers there.”</li>
            </ul>
            <p>
            ...
            <ul>
                <li>What problems does this team actually solve?</li>
                <li>What constraints are real vs historical accidents?</li>
                <li>What can I learn here that I couldn’t elsewhere?</li>
                <li>Who thrives here, and why?</li>
            </ul>
            <p>
            ...
            <h3>The danger of second-hand certainty</h3>
            <p>
            ...
            <h3>Flawed opinions are better than borrowed ones</h3>
            <p>
            ...
            <h3>World views compound quietly</h3>
            <p>
            ...
            <ul>
                <li>You outsource judgment.</li>
                <li>You narrow your curiosity.</li>
                <li>You slowly lose confidence in your own perception.</li>
            </ul>
            <p>
                If you habitually form your own:
            </p>
            <ul>
                <li>You become harder to manipulate.</li>
                <li>You tolerate ambiguity better.</li>
                <li>You see optionality where others see fate.</li>
            </ul>

            <h3>A simple rule I try to follow</h3>
            <p>
