export default function TheHedgeChanges() {
    return (
        <>
            ...
            <h3>At work, people become the hedge.</h3>
            <p>
            ...
            <ul>
                <li>You have to unlearn the reflex to always say no.</li>
                <li>Unlearn the belief that focusing on people is “wasted time.”</li>
                <li>Unlearn the idea that merit automatically surfaces.</li>
            </ul>
            <p>
            ...
            <p>
                <strong>people, not skills, are the real hedge in life.</strong>
            </p>
        </>
    );
}
